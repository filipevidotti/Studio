...
class EDD_Theme_Updater_Admin {
	...
	function __construct( $config = array(), $strings = array() ) {
		...
		// Config passed in from the updater config
		$this->strings = $config;
	...
	function license_page() {
		...
		?>
		<div class="wrap">
			<h2><?php esc_html_e( 'Theme License Manager', 'beonepage' ); ?></h2>

			<p><?php _e( 'Enter your theme license key to remove theme byline and receive automatic updates.', 'beonepage' ); ?></p>
