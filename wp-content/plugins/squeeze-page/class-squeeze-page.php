...
class SqueezeWP {
    ...
    private function __construct() {
        ...
        $this->pages_captura = array_merge($this->pages_captura_only, array('registro-webinario-1.php'));
        ...
        $this->pages_outras_paginas = array('lp-vendas-video-1.php', 'page-conversao-externa.php', 'page-entrega-video-1.php', 'page-agradecimento-1.php', 'pagina-texto-1.php');
        ...
        $this->pages_outras = array('webinario-1.php', 'funil-1.php', 'pagina-texto-1.php');
...
// end get_locale
    ...
    public function criar_form_modal($optin, $botao, $class_botao, $exibir_campos, $rotulos, $text_privacidade, $text_form, $icons, $botao_cta_modal) {
        ?>
        <!-- Modal -->
            ...
            <div class="<?php squeezewp_get_animacao('animated flipInX', true); ?> modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="head-form"><?php echo $text_form; ?></div>
    ...
    function is_page_sp($tipo = 'todas', $id) {
        ...
        if ($tipo == 'todas')
            $templates = array('sp-video-1.php', 'sp-padrao-1.php', 'sp-ebook-1.php', 'sp-ebook-2.php', 'sp-back-animado-1.php', 'sp-back-animado-2.php', 'confirme-inscricao-1.php', 'confirme-inscricao-2.php', 'page-download-1.php', 'page-download-2.php', 'lp-vendas-video-1.php', 'sp-video-background.php');
        if ($tipo == 'sp')
            $templates = array('sp-video-1.php', 'sp-padrao-1.php', 'sp-ebook-1.php', 'sp-ebook-2.php', 'sp-back-animado-1.php', 'sp-back-animado-2.php', 'sp-video-background.php');
        if ($tipo == 'conversao')
            $templates = $this->pages_conversao;
        if (in_array($template_name, $templates)) {
            $result = true;
