...
$titoption = array(
    ...
    'label' => '<h2 class="titulo">Formulário de Optin</h2>',
...
$optin = array($titoption, $sep, $texto_form, $optin, $placeholder_email, $exibir_campos,
...
$titsocial = array(
    ...
    'label' => '<h2 class="titulo">Redes sociais</h2>',
    'type' => 'title', // Obrigatório
);
...
$titcontador = array(
    ...
    'label' => '<h2 class="titulo">Contador Regressivo</h2>',
    'type' => 'title', // Obrigatório
);
...
$titanimacao = array(
    ...
    'label' => '<h2 class="titulo">Animações</h2>',
    'type' => 'title', // Obrigatório
);
...
$titopcoes = array(
    ...
    'label' => '<h2 class="titulo">Opções</h2>',
    'type' => 'title', // Obrigatório
);
...
$metabox_sp_ebook_1->set_fields(
        array_merge(array(
    $headline, $subheadline, $ebook, $titulo_descritivo, $texto_descritivo, $lista_beneficios
...
$metabox_lp_vendas_video_1->set_fields(
    ...
    $headline, $texto_cta, $cor_cta, $link_pagamento, $tempo_botao
...
$metabox_webinario_1->set_fields(
        array_merge(array($headline, $video, $url_comentarios), $animacoes, $opcoes, array($descricao)));
...
function add_jquery() {
    ...
    ?>
    <a class="inline-squeezewp" href="#data"></a>
    <script>
